...
class WalletTransactionsEntity extends Equatable {
  ...
  final List<WalletLinkEntity> links;
  ...
  const WalletTransactionsEntity({
    ...
    return WalletTransactionsEntity(
      ...
      links:
          (json['links'] as List<dynamic>?)
              ?.map((e) => WalletLinkEntity.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
...
class WalletLinkEntity extends Equatable {
  final String? url;
  final String label;
  final bool active;

  const WalletLinkEntity({this.url, required this.label, required this.active});

  factory WalletLinkEntity.fromJson(Map<String, dynamic> json) {
    return WalletLinkEntity(
